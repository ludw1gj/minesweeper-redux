...
- Reduced overall GC pressure
- Rewrote logic for better efficiency

## 6.1.1 - 2023-09-21

## Fixed

- Finding adjacent cells when grid is not symmetrical

### Changed

- Rewrote some logic for better readability

## 6.1.0 - 2023-09-21

### Changed

- Remove use of recursion, enabling grid above 100x100 in size
...
- Updated to TypeScript 3.4.3.
- Updated README with up-to-date types names.

## 5.2.0 - 2019-04-09

### Changed

- Internal refactor of core code into static class methods for better readability.
- Also a slight general refactor of core code.
- Added more tslint rules.

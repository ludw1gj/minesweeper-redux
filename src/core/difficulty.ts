import { IDifficulty } from "./core-types";
import { IllegalParameterError } from "./errors";
import { arePositiveIntegers } from "./util";

/** Default difficulty levels. */
export const defaultDifficultyLevels: { [key: string]: IDifficulty } = {
...
export function createDifficulty(height: number, width: number, numMines: number): IDifficulty {
